...
def create_note(
    ...
    Args:
        ...
        body: Optional body text appended after the header, separated by a
            blank line. Newlines in ``body`` are preserved verbatim. Falsy
            values (``None`` or empty string) leave the stub note unchanged.
